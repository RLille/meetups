create_meetup(
  ...
  rmd_params = list(
    ...
    abstract = paste(
      ...
      "Je vous propose ici de faire le point sur ces presques deux ans de R Lille, sur vos attentes, vos envies, mais aussi de se retrouver pour tout simplement discuter et se rencontrer.",
    ...
    biography = "R Lille", # biography of the speaker using Markdown syntax
